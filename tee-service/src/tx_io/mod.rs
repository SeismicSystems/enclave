...
pub fn enclave_ecdh_encrypt(pk: &PublicKey, data: Vec<u8>, nonce: u64) -> Result<Vec<u8>, anyhow::Error> {
...
/// the provided public key and the enclave's private key
pub fn enclave_ecdh_decrypt(pk: &PublicKey, data: Vec<u8>, nonce: u64) -> Result<Vec<u8>, anyhow::Error> {
