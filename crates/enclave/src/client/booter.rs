...
pub async fn boot_genesis_streamlined_async(client: &EnclaveClient) -> Result<(), anyhow::Error> {
...
pub fn boot_genesis_streamlined_sync(client: &EnclaveClient) -> Result<(), anyhow::Error> {
