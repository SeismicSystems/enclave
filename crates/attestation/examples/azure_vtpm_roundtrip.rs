...
//!
//! ```text
//! cargo run -p seismic-attestation --features azure-attester --example azure_vtpm_roundtrip -- \
...
fn main() {
    eprintln!("azure_vtpm_roundtrip must be run on an x86_64 Linux Azure TDX CVM");
    std::process::exit(1);
}
